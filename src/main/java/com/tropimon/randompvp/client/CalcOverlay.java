...
import com.tropimon.randompvp.calc.ResidualProjector;
...
public final class CalcOverlay implements HudRenderCallback {
    ...
    public void onHudRender(DrawContext context, net.minecraft.client.render.RenderTickCounter tickCounter) {
        ...
        for (Move coup : monComplet.getMoveSet()) {
            ...
            if (r.immunise) {
                ...
                boolean frappePhysiqueDef = capacite.getCategorie() == com.tropimon.randompvp.calc.Move.Categorie.PHYSIQUE
                ...
                if ((casqueBrut || epines)
                        && com.tropimon.randompvp.calc.ContactMoves.estContact(capacite.getNom())) {
    ...
    private static String ligneHypotheseObjet(Pokemon adversaire, Pokemon joueur,
                                               com.tropimon.randompvp.calc.Move capacite, Field field,
        ...
        String objetProbable = com.tropimon.randompvp.calc.ShowdownIdMapper.objet(smogon.topItemsShowdownId().get(0));
    ...
    private com.tropimon.randompvp.calc.Move convertirTemplate(MoveTemplate template) {
