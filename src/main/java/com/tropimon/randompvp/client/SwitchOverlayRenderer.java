package com.tropimon.randompvp.client;

import com.cobblemon.mod.common.api.moves.Move;
import com.cobblemon.mod.common.api.moves.MoveTemplate;
import com.cobblemon.mod.common.api.moves.Moves;
import com.cobblemon.mod.common.client.gui.battle.subscreen.BattleSwitchPokemonSelection;
import com.tropimon.randompvp.battle.BattleStateTracker;
import com.tropimon.randompvp.battle.BoostTracker;
import com.tropimon.randompvp.battle.FieldTracker;
import com.tropimon.randompvp.battle.ObservationCollector;
import com.tropimon.randompvp.battle.TypeTracker;
...
public final class SwitchOverlayRenderer {
    ...
    public static void render(BattleSwitchPokemonSelection ecran, DrawContext context, int mouseX, int mouseY) {
        ...
        for (Move coup : membre.getMoveSet()) {
            ...
            com.tropimon.randompvp.calc.Move capacite = convertirCapacite(coup);
        ...
        if (!coupsAdv.isEmpty()) {
            ...
            for (MoveTemplate template : coupsAdv) {
                ...
                com.tropimon.randompvp.calc.Move capaciteAdv = convertirTemplate(template);
    ...
    private static double degatsEntreePct(Pokemon candidat) {
        ...
        if (FieldTracker.isStealthRockJoueur()) {
            double eff = com.tropimon.randompvp.calc.PokemonType.ROCHE
    ...
    private static boolean picsToxikActifs(Pokemon candidat) {
        ...
        com.tropimon.randompvp.calc.PokemonType t1 = candidat.getType1();
        com.tropimon.randompvp.calc.PokemonType t2 = candidat.getType2();
        // Poison : absorbe les Pics Toxik au lieu d'être empoisonné (les retire même)
        if (t1 == com.tropimon.randompvp.calc.PokemonType.POISON
            || t2 == com.tropimon.randompvp.calc.PokemonType.POISON) return false;
        if (t1 == com.tropimon.randompvp.calc.PokemonType.ACIER
            || t2 == com.tropimon.randompvp.calc.PokemonType.ACIER) return false;
        return true;
    }

    /** Vrai si le candidat touche le sol (sensible à Picots et Toile Gluante). */
    private static boolean estAuSol(Pokemon candidat) {
        if (candidat.getType1() == com.tropimon.randompvp.calc.PokemonType.VOL
            || candidat.getType2() == com.tropimon.randompvp.calc.PokemonType.VOL) return false;
    ...
    private static com.tropimon.randompvp.calc.Move convertirCapacite(Move coup) {
        ...
        return com.tropimon.randompvp.calc.Move.builder(coup.getName(), type, categorie)
            .puissance((int) coup.getPower())
            
            .poing(com.tropimon.randompvp.calc.MoveFlags.estPoing(coup.getName()))
            .morsure(com.tropimon.randompvp.calc.MoveFlags.estMorsure(coup.getName()))
            .build();
    }

    private static com.tropimon.randompvp.calc.Move convertirTemplate(MoveTemplate template) {
