...
public final class FieldTracker {
    ...
    private static boolean rocheAllongeMeteo(Field.Meteo meteo) {
        ...
        try {
            com.tropimon.randompvp.calc.Pokemon joueur = BattleStateTracker.getJoueurActifDepuisEquipe();
            com.tropimon.randompvp.calc.Pokemon adversaire = BattleStateTracker.getAdversaireActif();
