...
public final class TypeTracker {
    ...
    public static void traiterMessage(Text message) {
        ...
        if (typechange) {
            ...
            if (joueur) {
                if (!joueurModifie) {
                    com.tropimon.randompvp.calc.Pokemon actif = BattleStateTracker.getJoueurActifDepuisEquipe();
                    if (actif != null) {
                ...
                if (!adversaireModifie) {
                    com.tropimon.randompvp.calc.Pokemon actif = BattleStateTracker.getAdversaireActif();
                    if (actif != null) {
    ...
    public static void appliquer(com.tropimon.randompvp.calc.Pokemon joueur,
                                  com.tropimon.randompvp.calc.Pokemon adversaire) {
        if (joueurModifie) {
    ...
    private static String especeActiveJoueur() {
        com.tropimon.randompvp.calc.Pokemon p = BattleStateTracker.getJoueurActifDepuisEquipe();
        return p != null ? p.getEspece() : null;
    }

    private static String especeActiveAdversaire() {
        com.tropimon.randompvp.calc.Pokemon p = BattleStateTracker.getAdversaireActif();
        return p != null ? p.getEspece() : null;
    }
